...
model39 <- load_cp(paste0(file.path("checkpoints"), "/", "rsd-permutation_39"), 
                 cp_filter = "last_ep")
special_seq <- permute_sequence(triplets, keyed, type="ok", min.subs=10, max.subs=30,
                                dict=codon.dict, spec.cond=FALSE, spec.region=NULL)
special_seq <- permute_sequence(special_seq, keyed, type="func", min.subs=10, max.subs=30,
