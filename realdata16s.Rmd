...
We also tried adversarial instance. We replace the selected spots of the instance all with C, and the confidence for 16S rRNA drops from **0.906 to 0.176**! Also replacing them with T reduces the confidence to 0.20. Replacing with A and G is not effective.
